...
EFFECTDESCRIPTIONS = [
    ...
    [6, "Your ultimate will unlock this many turns later than normal."],
    [7, "Your opponent's next attack will deal this much less damage."],
    [8, "Your opponent has to deal more damage than the threshold, or no damage at all."],
    [9, "Your opponent can't use debuffs on you. Your Royal Move and Composure become stronger."],
    [10, "This turn, you can use two skills but not your ultimate."],
    [11, "If you survive your opponent's next turn, fully heals you."],
    [13, "You heal from Euphoric Source at the end of each turn, but Source gets rapidly depleted."],
    [14, "Green tokens add Green damage to your Stab."],
    [15, "Black tokens add Black damage to your Stab."],
    [16, "Damage dealt by Royal Move. You can spend it on Composure heal or Pride damage."],
    [17, "Boosts your Electric Shock damage."],
    [18, "Boosts your Layers defense."],
    [19, "Euphoric Source gives your Pink Sphere additional damage as well as well as healing while in Euphoria."],
];
